...
class LearnedALSamplingLSTMClassifier(nn.Module):

	def __init__(self, embedding_dim, hidden_dim):
		super(LearnedALSamplingLSTMClassifier, self).__init__()
	...
	def forward(self, packed_batch):
		...
		system_obj_predictions = self.sigmoid(system_obj_outputs * torch.tensor(0.2))
